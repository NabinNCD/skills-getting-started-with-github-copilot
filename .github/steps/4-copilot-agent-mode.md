...
1. Open the **Copilot** chat panel and use the dropdown menu to switch to **Agent** mode.
   ...
   <img width="250" alt="agent mode" src="https://github.com/NabinNCD/skills-getting-started-with-github-copilot/blob/main/.github/images/agent-mode-dropdown.png?raw=true" />

1. Click on the **Tools** icon and explore all Tools currently available to Copilot Agent Mode.

   <img width="250"  alt="tools icon" src="https://github.com/NabinNCD/skills-getting-started-with-github-copilot/blob/main/.github/images/tools-icon.png?raw=true" />
